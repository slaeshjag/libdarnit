...
DARNIT_TEXT_SURFACE *darnitTextColorSurfaceAlloc(DARNIT_FONT *font, unsigned int glyphs, unsigned int linelen, int x, int y);
...
void darnitTextSurfaceCharColorNext(DARNIT_TEXT_SURFACE *surface, unsigned char r, unsigned char g, unsigned char b);
