...
unsigned int videoAddTextureRGBA4(void *data, unsigned int w, unsigned int h) {
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, w, h, 0, GL_RGBA4_OES, GL_UNSIGNED_SHORT_4_4_4_4, data);
...
unsigned int videoAddTextureRGB5A1(void *data, unsigned int w, unsigned int h) {
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, w, h, 0, GL_RGB5_A1_OES, GL_UNSIGNED_SHORT_5_5_5_1, data);
